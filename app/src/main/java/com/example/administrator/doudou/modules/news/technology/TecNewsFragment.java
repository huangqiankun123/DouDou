 ...
 */
public class TecNewsFragment extends BaseFragment implements NewImp.View {
    @BindView(R.id.recycler_view)
    XRecyclerView recyclerView;
    Unbinder unbinder;
    private Context context;
    private ArrayList<NewsBean> newsBeanList = new ArrayList<>();
    private TechnologyPresenter mPresenter = new TechnologyPresenter(this);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initView();
        Log.i("nihao","TecNewsFragment ---->onCreateView");
        return view;
    }
...
//        adapter.setOnItemClickListener(this);
    ...
    public void onDestroyView() {
        super.onDestroyView();
        unbinder.unbind();
        Log.i("nihao","TecNewsFragment ---->onDestroyView");
        adapter=null;
    }
