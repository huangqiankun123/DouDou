package com.example.administrator.doudou.disklrucache;
...
public class DiskCacheManager {
    ...
    private File getCacheFile(Context context, String uniqueName) {
        ...
        //SD卡正常挂载 Environment.MEDIA_MOUNTED.
        /*
            确认sdcard的存在
　　  * android.os.Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)
        ...
        //通过Context.getExternalCacheDir()方法可以获取到 SDCard/Android/data/你的应用包名/cache/目录，一般存放临时缓存数据
            ...
            cachePath = context.getCacheDir().getPath(); //缓存路径  当SD卡不存在或者没有找到SD卡时
        }
        return new File(cachePath + File.separator + uniqueName); //File.separator 默认分隔符
    }
    ...
    /*************************
     * 字符串读写  写入的操作是借助DiskLruCache.Editor这个类完成的
     *************************/
    /**
     * 缓存 String
     *
