 ...
 */
public class MilitaryFragment extends BaseFragment implements NewImp.View {
    @BindView(R.id.recycler_view)
    XRecyclerView recyclerView;
    Unbinder unbinder;
    private Context context;
    private ArrayList<NewsBean> newsBeanList = new ArrayList<>();
    private MiliteryPresenter mPresenter = new MiliteryPresenter(this);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initView();
        Log.i("nihao","MilitaryFragment ---->onCreateView");
        return view;
    }
...
//        }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        unbinder.unbind();
        Log.i("nihao","MilitaryFragment ---->onDestroyView");
        adapter=null;
    }
