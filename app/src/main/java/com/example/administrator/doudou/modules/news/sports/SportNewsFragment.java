 ...
 */
public class SportNewsFragment extends BaseFragment implements NewImp.View {
    @BindView(R.id.recycler_view)
    XRecyclerView recyclerView;
    Unbinder unbinder;
    private Context context;
    private ArrayList<NewsBean> newsBeanList = new ArrayList<>();
    private SportsPresenter mPresenter = new SportsPresenter(this);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initView();
        Log.i("nihao","SportNewsFragment ---->onCreateView");
        return view;
    }
...
//        }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        unbinder.unbind();
        Log.i("nihao","SportNewsFragment ---->onDestroyView");
        adapter=null;
    }
