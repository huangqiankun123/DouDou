 ...
 */
public class TravelFragment extends BaseFragment implements NewImp.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initView();
        Log.i("nihao","TravelFragment ---->onCreateView");
        return view;
    }
...
//        }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        unbinder.unbind();
        Log.i("nihao","TravelFragment ---->onDestroyView");
        adapter=null;
    }
