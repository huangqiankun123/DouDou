...
import com.example.administrator.doudou.modules.news.health.HealthPresenter;
 ...
 */
public class HealthFragment extends BaseFragment implements NewImp.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initView();
        Log.i("nihao","HealthFragment ---->onCreateView");
        return view;
    }
...
//        }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        unbinder.unbind();
        Log.i("nihao","HealthFragment ---->onDestroyView");
        adapter=null;
    }
